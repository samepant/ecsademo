  ...
  render() {
    return (
      <div className='hero' id='hero'>
        ...
        <p>Economic Space Agency (ECSA)  is a distributed and decentralized research and development organization with satellites in Berlin, Montreal, Rio de Janeiro. Our community of radical economists, artists, and cryptotechnologists are probing the unbounded frontier of economic spacetime by providing partnership, resources and team members to emerging crypto projects.</p>
